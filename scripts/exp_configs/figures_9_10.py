...
teleport_schedule_det = []
teleport_schedule_stoc = []
configurations = [
    (64, 5, 100, teleport_schedule_stoc),
    ("full_batch", 1, 500, teleport_schedule_det),
]
